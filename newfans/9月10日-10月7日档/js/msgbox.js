(function () {
    ...
    var generateCss = function () {
        $(".popMask").css({position:'fixed',left:'0',top:'0',zIndex:'99999',width:'100%',height:'100%',filter:'Alpha(opacity=80)',opacity:'0.6',backgroundColor:'#000'});
        $("#popBox").css({position:'fixed',zIndex:'999999',width:'80%',maxWidth:'300px',borderRadius:'5px',backgroundColor:'#fff'});
        ...
        $(".popIco").css({display:'block',position:'absolute',right:'10px',top:'9px',width:'18px',height:'18px',lineHeight:'18px',textAlign:'center',cursor:'pointer',borderRadius:'18px',fontFamily:'arial',border:'1px solid #fff',color:'#fff'});
        $(".btnBox").css({margin:'15px 0 10px 0',textAlign:'center'});
        $("#popBtnOk,#popBtnNo").css({width:'85px',height:'30px',color:'#fff',border:'none',borderRadius:'2px'});
